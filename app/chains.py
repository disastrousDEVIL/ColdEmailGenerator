...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Krish, a business development executive at XYZ. XYZ is an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are Krish, BDE at XYZ. 
